...
Neste projeto implentei funções a partir de requisitos solicitados pela Trybe. Um verdadeiro parque de diversões de funções em JavaScript.

# Objetivo do Projeto

- Entender que durante a a carreira como pessoa desenvolvedora, é importante saber quebrar grandes problemas em problemas menores e utilizar a lógica de programação na resolução;
